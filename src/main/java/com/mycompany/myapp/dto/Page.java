...
public class Page {
	...
	public Page(int pnum, String findkey, String findvalue, int curPage, int perPage, int perBlock, int totPage,
	...
	public String toString() {
		return "Page [pnum=" + pnum + ", findkey=" + findkey + ", findvalue=" + findvalue + ", curPage=" + curPage
